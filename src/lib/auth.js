...
export async function loginUser(username, password) {
  const { data: jwtBody, status: jwtStatus, error: jwtError } = await fetcher(
  ...
  const { data: userData, status: userStatus, error: userError } = await fetcher(
    `${API_BASE_URL}/users/me?context=edit`,
    {
